export default {
    global: {
        ...
        close: 'Fermer',
        confirm: 'Confirmer',
        discard: 'Jeter les changes',
        save: 'Sauvegarder',
        saveAndClose: 'Sauvegarde and fermer',
        submit: 'Soumettre',
        theme: 'Theme',
        language: 'Langue',
    },
    ...
    navigation: {
        ...
        create: 'Creer un nouveau',
        logIn: 'Connexion',
        logOut: 'Log out',
    },
    welcomeBanner: {
        gameJamSlogan: 'Découvrir et participer dans les game jams à Scratch',
        communitySlogan: 'Joindre la communauté',
        start: 'Commencer',
        moreInfo: 'Apprendre plus',
    },
    footer: {
        aboutTheSite: 'À propos d\'Itinerary',
        forDevelopers: 'Pour les developpeurs',
        affiliation: 'Itinerary n\'est pas affilié avec Scratch, l\'Équipe de Scratch, ou le Fondation de Scratch.',
        projectNature: 'Itinerary est un projet dont le code est ouvert à tous, avec des aspectes visuelles inspiré par <b>Ocular</b> (par <a href="https://scratch.mit.edu/users/Jeffalo"><b>@Jeffalo</b></a>) et <a href="https://scratch.mit.edu"><b>Scratch</b></a> (par le <b>Fondation à Scratch</b>).',
    },
    notifications: {
        global: {
            fillInRequiredFields: 'Remplir les boîtes vides.',
            invalidURL: 'Cette addresse de Web n\'est pas correct. Corrige-le et essayer encore.',
        },
        admin: {
            editingOwnProfile: 'Vous changez VOTRE profil! Fais attention.',
        },
        auth: {
            loggedOut: 'Vous etez désconnecté.',
            failedAuth: 'L\'authentification de FluffyScratch n\'a pas marché. Vous pouvez être un «New Scratcher», et ça confonde la système.',
            serverError: "Il y a un problème avec la communication entre nos serveurs et FluffyScratch. Essayer encore plus tard.",
